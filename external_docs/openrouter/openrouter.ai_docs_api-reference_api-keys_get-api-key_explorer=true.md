---
url: "https://openrouter.ai/docs/api-reference/api-keys/get-api-key?explorer=true"
...
GEThttps://openrouter.ai/api/v1/keys/hash
...
Use exampleClear form [View in API Reference](https://openrouter.ai/docs/api-reference/api-keys/get-api-key)

RequestcURLTypeScriptPython

```code-block text-xs

$curl https://openrouter.ai/api/v1/keys/hash \>     -H "Authorization: Bearer "
```
