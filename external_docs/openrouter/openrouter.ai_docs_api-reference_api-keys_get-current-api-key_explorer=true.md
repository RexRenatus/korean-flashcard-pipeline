---
url: "https://openrouter.ai/docs/api-reference/api-keys/get-current-api-key?explorer=true"
...
Use exampleClear form [View in API Reference](https://openrouter.ai/docs/api-reference/api-keys/get-current-api-key)

RequestcURLTypeScriptPython

```code-block text-xs

$curl https://openrouter.ai/api/v1/key \>     -H "Authorization: Bearer "
```
