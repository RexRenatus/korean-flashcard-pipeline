---
url: "https://openrouter.ai/docs/api-reference/list-available-providers?explorer=true"
...
Use exampleClear form [View in API Reference](https://openrouter.ai/docs/api-reference/list-available-providers)
